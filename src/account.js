						...
						<div className={styles.content__body}>
							<div className={styles.menu}>
									...
									<div className={styles.menu__list}>
										<a href='#' className={styles.menu__list_item}>About me</a>
										<a href='#' className={cn(styles.menu__list_item,styles.active)}>Account settings</a>
							...
							<div className={cn(styles.box,styles.account)}>
								<div className={styles.box__head} className={cn(styles.box__head,styles.account__head)}>
									<div className={cn(styles.box__head_txt,styles.account__head_txt)}>
										<h3>Account settings</h3>
										<p>You can change your email and password here</p>
									</div>
								</div>
								<div className={styles.account__tabs}>
									<ul className={styles.account__tabs_menu}>
										<li className={cn(styles.account__tabs_link,styles.account__tabs_link_active)}>Email</li>
										<li className={styles.account__tabs_link}>Password</li>
									</ul>
								</div>
								<div className={styles.account__tabs_content}>
									<div className={cn(styles.account__tabs_pane,styles.account__tabs_pane_show)}>
										<form className={cn(styles.form_account,styles.form_default)}>
											<div className={styles.default_input__wrap}>
												<label for='#input_email' className={styles.default_label}>Email</label>
												<Input type="email" placeholder='jadehopp@gmail.com' id='input_email' className={cn(styles.default_input,styles.default_input_profile)}></Input>
											</div>
											<div className={styles.default_input__wrap}>
												<label for='#input_password' className={styles.default_label}>Password</label>
												<Input type="password" placeholder='**********' id='input_password' className={cn(styles.default_input,styles.default_input_profile)}></Input>
											</div>
											<div className={styles.account__wrap_btns}>
												<a className={cn(styles.default_link,styles.link_forgot)} href="#">Forgot Password?</a>
												<Button className={styles.default_button} type='submit' disabled>Save</Button>
											</div>
										</form>
									</div>
									<div className={styles.account__tabs_pane}>
										<form className={cn(styles.form_account,styles.form_default)}>
											<div className={styles.default_input__wrap}>
												<label for='#input_password_current' className={styles.default_label}>Current password</label>
												<Input type="password" placeholder='**********' id='input_password_current' className={cn(styles.default_input,styles.default_input_profile)}></Input>
											</div>
											<div className={styles.default_input__wrap}>
												<label for='#input_password_new' className={styles.default_label}>New password</label>
												<Input type="password" placeholder='**********' id='input_password_new' className={cn(styles.default_input,styles.default_input_profile)}></Input>
											</div>
											<div className={styles.default_input__wrap}>
												<label for='#input_password_confirm' className={styles.default_label}>Confirm password</label>
												<Input type="password" placeholder='**********' id='input_password_confirm' className={cn(styles.default_input,styles.default_input_profile)}></Input>
											</div>
											<div className={styles.account__wrap_btns}>
												<a className={cn(styles.default_link,styles.link_forgot)} href="#">Forgot Password?</a>
												<Button className={styles.default_button} type='submit' disabled>Save</Button>
